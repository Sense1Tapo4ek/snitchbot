...
since: "0.1.0"
watermark: 見
summary: "Top-level container bundling the five anomaly detectors passed to init(anomaly=…)."
---
...
|---|---|---|---|
| `rss` | [`RssAnomalyConfig`](./rss-anomaly-config) `\| None` | Memory detector (ceiling / spike / drop). | `RssAnomalyConfig()` |
| `cpu` | [`CpuAnomalyConfig`](./cpu-anomaly-config) `\| None` | CPU% detector. | `CpuAnomalyConfig()` |
